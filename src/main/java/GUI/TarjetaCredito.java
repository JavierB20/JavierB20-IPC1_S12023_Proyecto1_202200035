 ...
 * @author Javier
 */
public class TarjetaCredito extends javax.swing.JFrame {

    /**
     * Creates new form TarjetaCredito
     */
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(162, 146, 169));

        jLabel1.setText("Ingrese tarjeta ");

        jLabel2.setText("Mantenimiento de Tarjetas");
        ...
        jList1.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Tarjetas Disponibles" };
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TarjetaCredito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TarjetaCredito().setVisible(true);
            }
        });
    }
